...
export function Footer() {
  return (
    <footer className="bg-blue-900 text-white relative mt-0">
      ...
      {/* 🌊 Bumpy Wave Boundary - Multiple Curves */}
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-blue-200 text-sm leading-relaxed">
              Empowering young minds through quality education and life skills in Huruma, Kiamaiko.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-blue-100 text-sm">
              <div className="flex items-start gap-2">
                <MapPin size={18} className="mt-0.5 text-peach-300 flex-shrink-0" />
                <span>Huruma, Kiamaiko, Mathare Sub-County<br/>Nairobi, Kenya</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone size={18} className="text-peach-300 flex-shrink-0" />
                <a href="tel:+254728654003" className="hover:text-peach-300 transition">
                  +254 728 654 003
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail size={18} className="text-peach-300 flex-shrink-0" />
