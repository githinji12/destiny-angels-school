  ...
  return (
    <div className="pt-20">
      <header className="bg-blue-900 text-white relative">
        ...
        {/* 🌊 Bumpy Wave Curve - Points Down into Gallery */}
        <div className="absolute bottom-0 left-0 w-full z-20">
          ...
          >
            {/* Multi-bump wave path - curves DOWNWARD */}
            <path 
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {galleryImages.map((img, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-blue-900/60 to-transparent opacity-0 group-hover:opacity-100 transition flex items-end p-4">
      ...
      {selected !== null && (
        <div className="fixed inset-0 z-50 bg-blue-900/95 flex items-center justify-center p-4" onClick={() => setSelected(null)}>
          <button className="absolute top-4 right-4 text-white hover:text-peach-300 transition" aria-label="Close lightbox"><X size={32} /></button>
